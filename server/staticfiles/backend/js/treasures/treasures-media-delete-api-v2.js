...
function deleteMediaTreasure(targetURL, form) {
    var response = {};
    const params = "?treasure_id=" + form.elements["treasureUuidInput"].value + "&media_id=" + form.elements["mediaUuidInput"].value;
    ...
    xhr.addEventListener("readystatechange", function () {
        ...
        if (xhr.status >= 200 && xhr.status < 300) {
            Swal.fire({
                text: "Media of Ecclesiastical Treasure has been successfully deleted!",
                icon: "success",
