...
var photosMediaDropzone = new Dropzone("#dropzonejs_photos_media", {
                ...
                reader.onload = function(event) {
                    ...
                    img.onload = function() {
                        if (img.width < minWidth || img.height < minHeight) {
                            ...
                            photosMediaDropzone.removeFile(file);
                        }
                        else {
                            photosMediaDropzone.processQueue();
                        }
                    };
    ...
    paramName: "file_src ",
    maxFiles: max_photos_media_files,
    maxFilesize: 100 * max_photos_media_files,
    addRemoveLinks: true,
    accept: function (file, done) {
        done();
    },
    params: {
        "media_id": $("#photos_uuid").val(),
        "type": "photo"
    },
