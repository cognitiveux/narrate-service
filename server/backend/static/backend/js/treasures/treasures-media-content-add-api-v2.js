...
var contentMediaDropzone = new Dropzone("#dropzonejs_content_media", {
                ...
                reader.onload = function(event) {
                    ...
                    img.onload = function() {
                        if (img.width < minWidth || img.height < minHeight) {
                            ...
                            contentMediaDropzone.removeFile(file);
                        }
                        else {
                            contentMediaDropzone.processQueue();
                        }
                    };
    ...
    paramName: "file_src ",
    maxFiles: max_content_media_files,
    maxFilesize: 100 * max_content_media_files,
    addRemoveLinks: true,
    accept: function (file, done) {
        done();
    },
    params: {
        "media_id": $("#content_uuid").val(),
        "type": "content"
    },
